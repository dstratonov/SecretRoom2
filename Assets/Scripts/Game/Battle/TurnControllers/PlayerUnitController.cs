...
namespace Game.Battle.TurnControllers
{
    public class PlayerUnitController : UnitController
    {
        ...
        private bool _isSelectionStage;
        ...
        private async UniTaskVoid ExecuteAbility()
        {
            _isSelectionStage = false;
            _activeTeam[_targetIndex].GetSystem<PawnSystem>().Pawn.Deselect();
            BattleActions.Disable();

            IAbilityExecutor executor = _abilityExecutionSubModule.GetAbilityExecutor(
                _unitAbilities[_selectedAbilityIndex],
                UnitModel,
                _activeTeam[_targetIndex]);
        ...
        {
            _eventBus.Fire(new TargetChangedEvent(target, UnitModel.GetSystem<PawnSystem>().Pawn));
        }
        ...
        private void SelectAbility()
        {
            ...
            switch (_selectedAbility.Data.selection)
            {
